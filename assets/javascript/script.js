...
// ---------------------------------
// Abertura de abas do menu
// ---------------------------------
(function configurarMenuDeLinks() {
    for (
        let contador = 0; 
        document.querySelectorAll('#menu_navegacao .aba_de_links')[contador] != undefined; 
        contador++
    ) {
        document.querySelectorAll('#menu_navegacao .aba_de_links')[contador].addEventListener(
            'click',
            function () {
                if (this.querySelectorAll('div')[0].style.display == 'none' || this.querySelectorAll('div')[0].style.display == '') {
                    this.querySelectorAll('div')[0].style.display = 'block';
                    this.querySelectorAll('div')[0].style.maxHeight = 'none';
                } else {
                    this.querySelectorAll('div')[0].style.maxHeight = '0vh';
                    this.querySelectorAll('div')[0].style.display = 'none';
                }
            },
            true
        );
...
function expandirMenu() {
    document.getElementById('menu_navegacao').classList.remove('display_none_768');
    setTimeout(() => {document.getElementById('menu_navegacao').style.maxHeight = '40vh';}, 100);

    document.getElementById('menu_abrir').style.display = 'none';
    document.getElementById('menu_fechar').style.display = 'block';
};
function recolherMenu() {
    document.getElementById('menu_navegacao').style.maxHeight = '0vh';
    setTimeout(() => {document.getElementById('menu_navegacao').classList.add('display_none_768');}, 100);

    document.getElementById('menu_abrir').style.display = 'block';
    document.getElementById('menu_fechar').style.display = 'none';
};
